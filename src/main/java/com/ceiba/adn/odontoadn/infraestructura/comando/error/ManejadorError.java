package com.ceiba.adn.odontoadn.infraestructura.comando.error;
...
import com.ceiba.adn.odontoadn.dominio.comando.excepcion.ExcepcionValorObligatorio;

@ControllerAdvice
public class ManejadorError extends ResponseEntityExceptionHandler {
	private static final Logger LOGMANEJADOR = LoggerFactory.getLogger(ManejadorError.class);
	...
	public final ResponseEntity<Error> handleAllExceptions(Exception exception) {
		...
		if (codigo != null) {
			...
			LOGMANEJADOR.error(excepcionNombre, exception);
